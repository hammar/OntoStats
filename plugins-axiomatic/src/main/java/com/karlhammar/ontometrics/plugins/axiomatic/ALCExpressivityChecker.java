...
import static com.karlhammar.ontometrics.plugins.axiomatic.ALCExpressivityChecker.Construct.*;
...
public class ALCExpressivityChecker implements OWLObjectVisitor {

    private Set<Construct> constructs;
    private Set<OWLOntology> ontologies;
    // if we don't declare this as static we'd have to do other ugly things
    // such as thread it through everything we're dealing with.
    // FIXME: this is asking for bugs!
    private static int alcAxiomCount = 0;
    ...
    public ALCExpressivityChecker(Set<OWLOntology> ontologies) {
        this.alcAxiomCount = 0; // zero this every time we crate a new object
        this.ontologies = ontologies;
        constructs = new HashSet<Construct>();
    }

    public int getALCAxiomCount () {
        getDescriptionLogicName(); //not cool
        return alcAxiomCount;
    }
