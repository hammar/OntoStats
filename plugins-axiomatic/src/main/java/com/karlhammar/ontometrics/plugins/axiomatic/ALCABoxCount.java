...
public class  ALCABoxCount extends OntoMetricsPlugin {
    private Logger logger = Logger.getLogger(getClass().getName());

    @Override
    public String getName() {
        return "The size of the subset of the ABox of this ontology that is in ALC.";
    }

    @Override
    public String getMetricAbbreviation() {
        return "ALCABoxAxiomCount";
    }
    ...
    public Optional<String> getMetricValue(File ontologyFile) {
        ...
        manager.addAxioms(ontology, owlapi.getOntology().getABoxAxioms(false));
